...
export default function Modal({ onClose, isOpen }) {
    ...
    useEffect(() => {
      ...
      const init = (message) => {
            ...
            let initMessageEl = document.createElement("div");
        ...
        const sendChatboxMessage = () => {
            ...
            let clientReplySectionEl = document.createElement("div")
            ...
            const fakeServerResponse = () => {
                let serverResponseEl = document.createElement("div")
  ...
  return (
    <div open={isOpen} className='chat-box' id="conversation" aria-live='polite'>
        <div className='chat-title'>
            <span>Chatbot</span>
            <button className='close-icon' aria-label="close" onClick={onClose}>X</button>
        </div>
        ...
        <div className='chat-body'>
            ...
            <div className='chat-input'>
                ...
                <button id="replyBtn" aria-label="Send">
                  <img src={img} alt="" />
               </button>
            </div>
        </div>
